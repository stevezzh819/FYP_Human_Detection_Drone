...
#include "i2cdev.h"
#include "../interface/multiranger.h"
#include "range.h"
...
uint16_t multirangerGetDistance(multirangerSensor_t sensor)
{
    ...
    switch (sensor) {
        case multirangerFront:
            value = (uint16_t)rangeGet(rangeFront);
            break;
        case multirangerBack:
            value = (uint16_t)rangeGet(rangeBack);
            break;
        case multirangerLeft:
            value = (uint16_t)rangeGet(rangeLeft);
            break;
        case multirangerRight:
            value = (uint16_t)rangeGet(rangeRight);
            break;
        case multirangerUp:
            value = (uint16_t)rangeGet(rangeUp);
            break;
        default:
            value = 0;
            break;
